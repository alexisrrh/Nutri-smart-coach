...
export function normalizeProfile(data) {
  ...
  return {
    ...
    premium_product_id: data.premium_product_id || null,
    premium_platform_transaction_id: data.premium_platform_transaction_id || null,
    premium_last_verified_at: data.premium_last_verified_at || null,
