  ...
  scrollClassName="[scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
     <section className="flex flex-col gap-1 pb-6">
          ...
          >
            ...
            <div className="relative mt-1.5">
              ...
              <input
                ...
                placeholder={t("meals.history.searchPlaceholder")}
          ...
          >
            <div>
              <h2 className="text-[13px] font-black tracking-tight text-[var(--app-text)]">
                {t("meals.history.timelineTitle")}
              </h2>
              <p className="mt-0.5 text-[9px] font-bold uppercase tracking-wide text-[var(--app-muted)]">
                {t("meals.history.timelineShown", { count: filteredMeals.length })}
              </p>
            </div>
      ...
      <ConfirmDialog
        ...
        variant="danger"
        title={t("meals.confirm.title")}
        description={t("meals.confirm.description")}
        cancelLabel={t("meals.confirm.cancel")}
        confirmLabel={t("meals.confirm.confirm")}
