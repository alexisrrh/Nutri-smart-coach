        ...
        <section className="relative z-10 px-5 py-5 flex flex-col flex-1">
          ...
          <nav className="flex items-center justify-between border-b border-white/10 pb-4 mb-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <Link to="/registro" className="rounded-full bg-white px-3 py-1.5 text-[9px] font-black uppercase tracking-wider text-[#03110d] transition hover:bg-emerald-400">Empezar</Link>
            </div>
          </nav>
          ...
          <div className="flex-1 flex flex-col gap-4 overflow-visible">
            <div className="text-center mb-2">
                <h1 className="text-[2rem] font-black italic uppercase tracking-tight leading-none block">
                    My <span className="inline-block bg-gradient-to-r from-emerald-300 via-emerald-400 to-cyan-300 bg-clip-text text-transparent pr-[0.15em] -mr-[0.15em]">Progress</span>
                </h1>
                <p className="mt-1.5 text-[8px] font-black uppercase tracking-[0.3em] text-emerald-300/60">Métricas en tiempo real</p>
            </div>

            <div className="rounded-2xl border border-emerald-500/20 bg-emerald-500/5 p-4 flex items-center gap-3 shadow-[inset_0_0_15px_rgba(16,185,129,0.1)]">
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-emerald-400/10 text-emerald-300 shadow-[0_0_10px_rgba(16,185,129,0.2)]">
                <Award size={20} />
              </div>
            ...
            <div className="grid grid-cols-2 gap-2">
              <MetricCard title="Grasa" value="14.2%" change="-1.5%" icon={<TrendingUp size={14} className="text-emerald-400 rotate-180" />} />
          ...
          <div className="w-full mt-4 mb-12">
              <Link to="/registro" className="group flex w-full items-center justify-center gap-2 rounded-xl bg-emerald-400 py-4 text-xs font-black uppercase tracking-widest text-[#03110d] shadow-[0_12px_30px_rgba(16,185,129,0.25)] transition-all hover:bg-white active:scale-[0.95]">
