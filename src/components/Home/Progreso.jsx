        ...
        <section className="relative z-10 flex-1 overflow-y-auto overflow-x-hidden scrollbar-hide px-5">
          ...
          <div className="flex flex-col gap-5 py-6">
            ...
            <div className="text-center">
                <h1 className="text-[2.2rem] font-black italic uppercase tracking-tighter leading-none text-[var(--app-text)]">
            ...
            {/* BANNER DE LOGRO */}
            <div className="rounded-2xl border border-[var(--app-border)] bg-[var(--app-primary-soft)] p-4 flex items-center gap-4 shadow-[inset_0_0_15px_var(--app-glow)] relative overflow-hidden group">
              ...
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-[var(--app-surface)] text-[var(--app-primary)] shadow-[0_0_10px_var(--app-glow)] border border-[var(--app-border)]">
                <Award size={20} />
              </div>
            ...
            <div className="space-y-3">
              ...
              <div className="rounded-3xl border border-[var(--app-border)] bg-[var(--app-surface)]/50 p-5 backdrop-blur-md shadow-xl">
