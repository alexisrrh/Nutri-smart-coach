...
export default function AIOrb() {
  return (
    <div className="relative flex h-[132px] w-[132px] items-center justify-center">
      ...
      <div className="absolute inset-0 animate-[spin_3s_linear_infinite] rounded-full border border-[#10b981]/20 border-t-[#10b981]" />

      <div className="absolute inset-[12px] animate-[spin_4s_linear_infinite_reverse] rounded-full border border-cyan-300/10 border-b-cyan-300/40" />

      <div className="absolute inset-[26px] rounded-full border border-white/10 bg-black/35 backdrop-blur-xl" />

      <div className="absolute inset-[42px] rounded-full bg-gradient-to-br from-[#10b981] via-emerald-200 to-cyan-300 shadow-[0_0_45px_#10b98188]" />
